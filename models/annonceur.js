...
class Annonceur{
    ...
    static getPanel(id){
        return new Promise((resolve,reject)=>{
            let sql = `select pan.pan_list_photo,pan.pan_list_photo_pose,pan.pan_list_photo_solarpro,
            pan.pan_publoc_ref,pan.pan_surface,pan.pan_state,pan.pan_lumineux,
