...
class Hospitalisation{
    static async register(req,res){ 
        ...
        let hospitalisation_data={
            ...
            util_id:{front_name:'util_id',fac:true ,format:(a)=> new parseInt(a)},
            pat_id:{front_name:'pat_id',fac:true ,format:(a)=> new parseInt(a)},
            dep_id:{front_name:'dep_id',fac:true ,format:(a)=> new parseInt(a)},
            ent_id:{front_name:'ent_id',fac:true ,format:(a)=> new parseInt(a)},
            tarif_id:{front_name:'tarif_id',fac:true ,format:(a)=> new parseInt(a)},
            hops_total_payer:{front_name:'hops_total_payer',fac:false ,format:(a)=> new parseInt(a)},
            hops_total_avancer:{front_name:'hops_total_avancer',fac:false ,format:(a)=> new parseInt(a)},
            hops_rest_apayer:{front_name:'hops_rest_apayer',fac:false ,format:(a)=> new parseInt(a)},
