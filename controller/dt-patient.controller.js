...
class Patient{
    ...
    static async getList(req,res){ 
        ...
        try { 
            ...
            let reponse = await D.exec_params(`select * from patient_dt where pat_nom_et_prenom like ? order by ${filters.sort_by} limit ?`,[filters.search,filters.limit])

            //Liste total des patient
            let nb_total_patient = (await D.exec('select count(*) as nb from patient_dt'))[0].nb
