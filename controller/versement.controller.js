...
class Versement{
    static async register(req,res){ 
        ...
        let versement_data={
            ...
            dep_id:{front_name:'dep_id',fac:true ,format:(a)=> new parseInt(a)},
            versmnt_date_versement:{front_name:'versmnt_date_versement',fac:false ,format:(a)=> new parseInt(a)}, 
            versmnt_font_caisse:{front_name:'versmnt_font_caisse',fac:true ,format:(a)=> new parseInt(a)}, 
            versmnt_recette_esp:{front_name:'versmnt_recette_esp',fac:true ,format:(a)=> new parseInt(a)},
            versmnt_recette_total:{front_name:'versmnt_recette_total',fac:true ,format:(a)=> new parseInt(a)},
            versmnt_total_cheque:{front_name:'versmnt_total_cheque',fac:true ,format:(a)=> new parseInt(a)},
            versmnt_total_versement:{front_name:'versmnt_total_versement',fac:true ,format:(a)=> new parseInt(a)},
            versmnt_remborser:{front_name:'versmnt_remborser',fac:true ,format:(a)=> new parseInt(a)},
