...
router.post('/hosp',require('../controller/hospitalisation.controller').create); // Ajout des données de l'hospitalisation
router.get('/hosp',require('../controller/hospitalisation.controller').getListHosp); // récupération des données hospitalisation
router.delete('/hosp/:ref',require('../controller/hospitalisation.controller').deleteHosp); // Suppression d'une ligne d'hospitalisation par paramètre
...
router.post('/entreprise',require('../controller/entreprise.controller').update);
...
router.post('/payement',require('../controller/payement.controller').update);
...
router.post('/service',require('../controller/service.controller').update);
...
router.post('/detail',require('../controller/detail.controller').update);
...
router.post('/tarif',require('../controller/tarif.controller').update);
...
router.post('/departement',require('../controller/departement.controller').update);
...
router.post('/hospitalisation',require('../controller/hospitalisation.controller').update);
...
router.post('/versement',require('../controller/versement.controller').update);
